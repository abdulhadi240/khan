                            ...
                            <div className="col-lg-12 align-self-center">
                                <div className="slide-item-info">
                                    <div className="slide-item-info-inner ltn__slide-animation">
                                        <h6 className="slide-sub-title white-color animated"><span><FaHome/></span>Construction Company</h6>
                                        <h1 className="slide-title text-uppercase white-color animated ">Build Your Dream <br/> House By Us</h1>
                                    </div>
                                </div>
                            </div>
                        </div>
